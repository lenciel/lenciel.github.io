...
- **Vector和Raster图片** ：首先你要明白[vector](http://en.wikipedia.org/wiki/Vector_graphics)和[raster](http://en.wikipedia.org/wiki/Raster_graphics)的区别。如果可能的话，尽量使用 vector，特别是在早期 MVP 阶段。
